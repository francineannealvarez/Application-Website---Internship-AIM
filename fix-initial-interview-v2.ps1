# ============================================
# FIX v2: Initial Interview Viber message (re-saved with UTF-8 BOM
# so Windows PowerShell reads special characters like em-dash correctly)
# ============================================
...
Write-Host ""
Write-Host "Done! Naayos na rin ang mga garbled na em-dash/en-dash characters." -ForegroundColor Cyan
