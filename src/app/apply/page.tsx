    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
            ...
            {[1, 2, 3, 4].map((step) => (
              <div
                ...
                className={`h-2 flex-1 mx-1 rounded-full ${
                  step <= currentStep ? 'bg-[#00AEEF]' : 'bg-gray-300'
                }`}
              />
            ))}
          </div>
          <div className="flex justify-between text-sm font-medium">
            <span className={currentStep >= 1 ? 'text-[#00AEEF]' : 'text-gray-600'}>
              Personal
            </span>
            <span className={currentStep >= 2 ? 'text-[#00AEEF]' : 'text-gray-600'}>
              Position
            </span>
            <span className={currentStep >= 3 ? 'text-[#00AEEF]' : 'text-gray-600'}>
              Documents
            </span>
            <span className={currentStep >= 4 ? 'text-[#00AEEF]' : 'text-gray-600'}>
              Review
            </span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-8">
          ...
          {currentStep === 1 && (
            <div>
              <h2 className="text-2xl font-bold text-[#1B3A5C] mb-6">Personal Information</h2>
          ...
          {currentStep === 2 && (
            <div>
              <h2 className="text-2xl font-bold text-[#1B3A5C] mb-6">Position & Availability</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          {currentStep === 3 && (
            <div>
              <h2 className="text-2xl font-bold text-[#1B3A5C] mb-6">Documents</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          {currentStep === 4 && (
            <div>
              <h2 className="text-2xl font-bold text-[#1B3A5C] mb-6">Review Your Application</h2>
          ...
          <div className="flex justify-between mt-8">
            ...
            {currentStep < 4 ? (
              <button
                ...
                className="px-6 py-2 bg-[#00AEEF] text-white rounded-lg hover:bg-[#0099CC]"
              >
                Next
              </button>
            ) : (
